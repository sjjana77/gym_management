<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu <?php if(in_array($page, ['members', 'members-entry', 'members-remove', 'members-update'])){ echo 'active open'; }?>" > <a href="#"><i class="fas fa-users"></i> <span>Manage Members</span> <span class="label label-important"><?php include 'dashboard-usercount.php';?> </span></a>
      <ul>
    ...
    <li class="submenu <?php if(in_array($page, ['list-equip', 'add-equip', 'remove-equip', 'update-equip'])){ echo 'active open'; }?>"> <a href="#"><i class="fas fa-dumbbell"></i> <span>Gym Equipment</span> <span class="label label-important"><?php include 'dashboard-equipcount.php';?> </span></a>
    <ul>
    ...
    <li class="submenu <?php if(in_array($page, ['attendance', 'view-attendance'])){ echo 'active open'; }?>"><a href="#"><i class="fas fa-calendar-alt"></i> <span>Attendance</span></a>
      <ul>
    ...
    <li class="submenu <?php if(in_array($page, ['chart', 'member-repo', 'c-p-r'])){ echo 'active open'; }?>"> <a href="#"><i class="fas fa-file"></i> <span>Reports</span></a>
    <ul>
